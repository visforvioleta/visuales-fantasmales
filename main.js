...
const visuals = [
  () => osc(5, 0.175, 2)
    ...
    .mult(src(s0).saturate(1.5).scale(1.35, 9 / 12))
    .out(o0),
...
// --- Captura de pantalla (desactivada) ---
// Para activar, descomenta el bloque y el botón en HTML
/*
...
// Alternativa usando html2canvas
document.getElementById("screenshot").onclick = () => {
